	...
	return (
		<ol className="flex flex-col gap-6">
			...
			<Step title="Query Supabase data from Next.js">
				<p>
					To create a Supabase client and query data from an Async Server Component, create a new page.tsx file at <span className="px-2 py-1 rounded-md bg-foreground/20 text-foreground/80">/app/notes/page.tsx</span> and add the following.
				</p>
				<Code code={server} />
